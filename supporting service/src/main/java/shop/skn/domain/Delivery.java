...
import shop.skn.domain.DeliveryReturned;
import shop.skn.domain.DeliveryStarted;
...
public class Delivery {
    ...
    public static DeliveryRepository repository() {
        DeliveryRepository deliveryRepository = SupportingServiceApplication.applicationContext.getBean(
